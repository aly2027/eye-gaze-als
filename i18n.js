...
(function (global) {
  ...
  var DICT = {
    ...
    ko: {
      ...
      "feat.3.h": "음성으로 출력",
      "feat.3.p": "완성된 단어는 내장 음성 변환(TTS)으로 읽어주어, 보호자가 즉시 들을 수 있습니다.",
      "feat.4.h": "실제 사용을 고려한 설계",
      "feat.4.p": "큰 선택 영역, 높은 명암비의 글자, 보호자에게 자주 하는 말 — 접근성을 나중에 덧붙이지 않고 처음부터 설계했습니다.",

      "how.eyebrow": "사용 방법",
      "how.h2": "짧은 코드에서 목소리까지.",
      "how.1.h": "단어의 코드 확인",
      "how.1.p": "단어판의 모든 단어에는 짧은 이진 코드가 함께 표시됩니다. 왼쪽 응시는 0, 오른쪽 응시는 1입니다. 환자는 말하고 싶은 단어를 찾아 그 코드를 확인합니다.",
      "how.2.h": "좌우 응시로 코드 만들기",
      "how.2.p": "왼쪽을 응시하면 0이, 오른쪽을 응시하면 1이 입력됩니다. 입력할 때마다 화면에 한 자리씩 표시되어 만들어지는 코드를 실시간으로 확인할 수 있습니다.",
      "how.3.h": "중앙 응시로 발화",
      ...
      "foot.tagline": "접근 가능한 시선 응시 의사소통을 통해 ALS 환자분들의 목소리와 자립을 되찾고자 합니다.",
      "foot.product": "제품",
      "foot.contact": "연락처",
