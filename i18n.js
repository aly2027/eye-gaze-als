...
(function (global) {
  ...
  var DICT = {
    en: {
      ...
      "routes.h": "Two ways to install",
      "routes.a.tag": "Straight away",
      "routes.a.name": "Download the file (APK)",
      "routes.a.body": "The button here gives you the file directly. No account, no waiting. When a new version comes out, you come back to this page to get it.",
      "routes.b.tag": "Via Google Play",
      "routes.b.name": "Tester version",
      "routes.b.body": "Leave a Gmail address in the form and we'll send you an invitation. It takes a few days, but installing is simpler and new versions arrive on their own.",
      ...
      "form.email": "Email <span class=\"opt\">(optional — for a Google Play tester invitation)</span>",
    ...
    ko: {
      ...
      "routes.a.tag": "지금 바로",
      "routes.a.name": "파일로 받기 (APK)",
      "routes.a.body": "여기 버튼으로 설치 파일을 바로 받으실 수 있습니다. 계정도 기다림도 필요 없습니다. 다만 새 버전이 나오면 이 사이트에 다시 오셔서 받으셔야 합니다.",
      "routes.b.tag": "구글 플레이로",
      "routes.b.name": "테스터 버전",
      "routes.b.body": "신청란에 Gmail 주소를 남겨주시면 초대를 보내드립니다. 며칠 걸리지만 설치가 간단하고, 새 버전이 저절로 업데이트됩니다.",
      ...
      "form.email": "이메일 <span class=\"opt\">(선택 — 구글 플레이 테스터 버전 초대를 받고 싶으시면)</span>",
